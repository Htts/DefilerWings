...
screen sc_disclaimer:
    frame:
        ...
        text("   This game contents multiple scenes of extreme violence and strong sexual content, and thus cannot be recommended to anyone. PG-99.\n"
            "   By cliking “proceed” you confirm that you are an adult and choose to play at your own risk. This game is NOT meant to be commercially distributed. All graphical, audio and text elements used in the game are either freely available on internet or created by authors of the game, and used for the sake of parody.\n"
            "   Program code of the game, created by our team, is licensesd under the BSD license (see LICENCE.txt for details)\n"
